...
const NISHIWAKI_BLOG = {
  ...
  shichoHoshu: "https://go2senkyo.com/seijika/200151/posts/1482320",
...
export const CANDIDATES: Candidate[] = [
  ...
  },
  {
    ...
    party: "無所属（表明時点）",
    lead: "「市民の手取りを増やします。」を掲げ、住民税5％減税・第一子からの保育料無償化・市長報酬1,000万円削減を柱に据える。財源や試算の前提までブログで公開している。",
    ...
    claims: [
      {
        label: "基本姿勢",
        text: "「市民の手取りを増やします。」を掲げている。以前は「国がやらないなら、福岡から。暮らしを変える政治を。」を掲げていた。",
      },
      {
        label: "3つの柱",
        text: "住民税5％減税、第一子からの保育料無償化、市長報酬1,000万円削減の3点を公約として掲げている。",
      },
      {
        label: "説明の姿勢",
        text: "減税額のモデル計算や財源、確定していない数字がどれかまでをブログで自ら示し、「都合のいい数字を確定額のように見せることはしません」としている。",
      },
      {
        label: "検討中の政策",
        text: "上記のほかに交通・生活環境など25項目を挙げ、「これから詳細をアップしようと考えているリスト」としている。個々の内容は今後の公表待ち。",
      },
    ],
    ...
    positions: {
      kosodate: {
        stance: "表明済み",
        summary:
          "0〜2歳児の保育料を第一子から無償化するとしている。保育料を理由に就労を諦めなくてよい環境づくりが狙いで、必要額は市が未公表のため「年間数十億円規模を想定し、精密な財政シミュレーションを行う」としている。ほかに出生順位によらない子育て現金給付、保育士の給与引き上げを挙げている。",
        updated: "2026年8月",
        log: [
          {
            date: "2026-08",
      ...
      bosai: {
        stance: "表明済み",
        summary:
          "阪神・淡路大震災の被災経験をもとに、避難所の環境やプライバシー、子ども・高齢者・障がいのある人・ペットへの対応、在宅避難や車中泊、避難生活が長期化した後の生活再建までを含めた防災を掲げている。あわせて各戸・各棟の電源確保による在宅避難と、マンション・賃貸にも届く蓄電池補助を挙げている。",
        updated: "2026年8月",
        log: [
          {
            date: "2026-08-27",
      ...
      zaisei: {
        stance: "表明済み",
        summary:
          "「住民税5％減税」として、市民税の所得割を8％から7.6％へ引き下げるとしている。県民税2％は市長の権限外で、年収500万円のモデルでは負担軽減が月約800円になると自ら説明している。財源は財政調整基金の取り崩しではなく行政の効率化などで生み出す恒常的な財源によるとし、あわせて市長報酬の年間1,000万円削減を掲げている。",
        updated: "2026年8月",
        log: [
          {
            date: "2026-08",
          ...
          },
          {
            ...
            place: "ブログ",
            source: NISHIWAKI_BLOG_SOURCE,
            text: "市長報酬を年間1,000万円削減すると表明。「市民に負担をお願いする前に、まずは自分から」としている。",
            url: NISHIWAKI_BLOG.shichoHoshu,
          },
          {
            date: "2026-08-28",
            place: "ブログ",
      ...
      sonota: {
        stance: "表明済み",
        summary:
          "外国人政策について「増やすこと自体を目的とする政策」には反対、「一括りに排除すること」にも反対とし、日本で暮らす人が生活のルールや文化を学ぶ場として「FUKUOKA JAPAN 道場」の設置を掲げている。ほかに路上喫煙対策と喫煙可否の店頭表示義務化、ポイ捨ての厳罰化、害虫根絶計画、投票を楽しい体験として設計する「VOTEFES」を挙げている。",
        updated: "2026年8月",
        log: [
          {
            date: "2026-08-27",
